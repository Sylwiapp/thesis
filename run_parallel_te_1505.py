...
fig2.savefig('plots/epoch2_network1105_all.png')
plt.show()
plt.close(fig2)
print("Zapisano: plots/epoch2_network1105_all.png")
...
fig3.savefig('plots/epoch2_lag_histogram1105.png')
plt.close(fig3)
print("Zapisano: plots/epoch2_lag_histogram1105.png")
...
for tgt in targets:
    ...
    fig4.savefig(f'plots/epoch2_target{tgt}_timeseries1105.png')
    plt.close(fig4)
    print(f"Zapisano: plots/epoch2_target{tgt}_timeseries1105.png")
